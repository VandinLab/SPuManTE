...
'-Wpointer-arith',
'-Wcast-qual',
'-Wno-missing-braces', # See https://bugs.llvm.org//show_bug.cgi?id=21629
'-fexceptions',
'-fopenmp',
#'-DNDEBUG',
...
#compilation_database_folder = '/Users/matteo/Documents/uni/res/s2udra/exper/src/'
compilation_database_folder = ''
# Matteo: Due to a limitation in libclang we cannot use the database (see
# https://github.com/Valloric/YouCompleteMe#completion-doesnt-work-with-the-c-standard-library-headers)
